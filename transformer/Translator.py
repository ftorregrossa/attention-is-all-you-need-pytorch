...
from aiaynpt.transformer.Models import Transformer
from aiaynpt.transformer.Beam import Beam
...
class RawTranslator(object):
    ...
    def translate_batch(self, src_batch):
        ...
        #--- Prepare beams
        beams = [Beam(beam_size, self.cuda) for _ in range(batch_size)]
        beam_inst_idx_map = {
        ...
        for i in range(self.max_token_seq_len):
            ...
            dec_output, *_ = self.model.decoder(
                dec_partial_seq, dec_partial_pos, enc_output)
